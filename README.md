...
| [`dev-secrets`](skills/dev-secrets/SKILL.md) | Local env files need agent-safe vaulting, manifests, scans, or rotation guidance. | Safe evidence, warnings, next command, approval gates, recovery steps. |
